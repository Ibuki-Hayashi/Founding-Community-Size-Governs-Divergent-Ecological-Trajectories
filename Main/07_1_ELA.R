set.seed(123)
n.core <- 4 #- Number of cores for parallel processing; adjust this based on your system's capabilities.
...
for(i in 1:2){ #- i=2; i=1 #- i=1 soil; i=2 water
  for(j in 1:4){ #- j=4 #- j=1; j=2; j=3; j=4 #- j=1 1; j=2 0.1; j=3 0.01; j=4 0.001
    input <- ddd[[i]][[j]]
