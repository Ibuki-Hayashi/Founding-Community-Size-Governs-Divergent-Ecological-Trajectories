...
for(m in 1:length(Msegs)){ #- m=1
  ...
  for(i in 6){ #- i=6
    ...
    write.csv(ans, sprintf("Output/Ecoregime_soil/figures/Minsegs_%s/Metrices_%s_Size.csv", Msegs[m], tax[i]))
    ...
    write.csv(ans, sprintf("Output/Ecoregime_soil/figures/Minsegs_%s/Metrices_%s_Link.csv", Msegs[m], tax[i]))
    ...
    write.csv(ans, sprintf("Output/Ecoregime_soil/figures/Minsegs_%s/Metrices_%s_Density.csv", Msegs[m], tax[i]))
    ...
    write.csv(ans, sprintf("Output/Ecoregime_soil/figures/Minsegs_%s/Metrices_%s_Depth.csv", Msegs[m], tax[i]))
    ...
    write.csv(ans, sprintf("Output/Ecoregime_soil/figures/Minsegs_%s/Metrices_%s_Rank.csv", Msegs[m], tax[i]))
  }
}
