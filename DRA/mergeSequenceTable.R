...
##
## 2023. 7. 5
## Filtering ASV sample
## & merge ASV table + convert to OTU table
##
##############################################

# Set working directory at containing "~stall_no_rmChimera.rds"
#- setwd("/media/toju/af760a9f-2043-43c2-8887-ccb358ca8e6d/Hirata/Merge_claident/RDS")
dir.name <- "result"

dir.create(sprintf("../%s",dir.name))
output.path <- sprintf("../%s",dir.name)
## ======================================== ##

# -- If you want sum up sequence read,you select "sum".
type="sum"

reference="silva_nr99_v138_train_set_append_stdDNA.fa"
##############################################
...
taxa <- assignTaxonomy(seqtab.nochim, sprintf("/home/toju/R_code/DADA2/function_refrence/%s", reference), multithread=TRUE)
...
system2(command = "/home/toju/miniconda3/bin/vsearch", 
