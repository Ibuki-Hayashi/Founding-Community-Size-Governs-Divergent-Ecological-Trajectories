...
copy <- readRDS(sprintf("%s/HS3_eachASV.rds", dd))
OTU99tab <- readRDS(sprintf("%s/seqOTUtab_99.rds", dd)); class(OTU99tab) <- "numeric"
OTU97tab <- readRDS(sprintf("%s/seqOTUtab_97.rds", dd)); class(OTU97tab) <- "numeric"
...
pdf(sprintf("%s/Inoculum_Rarefy.pdf", fd))
