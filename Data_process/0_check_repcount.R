library(ggplot2); library(vegan); library(stringr); library(tibble); library(RColorBrewer); library(scales)
...
rr_func <- function(data, taxt, day, sna, sn, seed=1112){
  ...
  #ps_all <- phyloseq(otu_table(as.matrix(data[,(7:ncol(data))])),
  #                   tax_table(as.matrix(taxt)))
...
rr_func(data=D_soil_OTU, taxt=, day=2,
        sna=sprintf("%s/Rarecurve_soil_OTU_day2.pdf", fd), sn=50)
rr_func(data=D_soil_OTU, taxt=, day=4,
        sna=sprintf("%s/Rarecurve_soil_OTU_day4.pdf", fd), sn=50)
rr_func(data=D_soil_OTU, taxt=, day=6,
        sna=sprintf("%s/Rarecurve_soil_OTU_day6.pdf", fd), sn=50)
rr_func(data=D_soil_OTU, taxt=, day=8,
        sna=sprintf("%s/Rarecurve_soil_OTU_day8.pdf", fd), sn=50)

rr_func(data=D_soil, taxt=, day=2,
        sna=sprintf("%s/Rarecurve_soil_ASV_day2.pdf", fd), sn=50)
rr_func(data=D_soil, taxt=, day=4,
        sna=sprintf("%s/Rarecurve_soil_ASV_day4.pdf", fd), sn=50)
rr_func(data=D_soil, taxt=, day=6,
        sna=sprintf("%s/Rarecurve_soil_ASV_day6.pdf", fd), sn=50)
rr_func(data=D_soil, taxt=, day=8,
        sna=sprintf("%s/Rarecurve_soil_ASV_day8.pdf", fd), sn=50)

rr_func(data=D_water_OTU, taxt=, day=2,
        sna=sprintf("%s/Rarecurve_water_OTU_day2.pdf", fd), sn=50)
rr_func(data=D_water_OTU, taxt=, day=4,
        sna=sprintf("%s/Rarecurve_water_OTU_day4.pdf", fd), sn=50)
rr_func(data=D_water_OTU, taxt=, day=6,
        sna=sprintf("%s/Rarecurve_water_OTU_day6.pdf", fd), sn=50)
rr_func(data=D_water_OTU, taxt=, day=8,
        sna=sprintf("%s/Rarecurve_water_OTU_day8.pdf", fd), sn=50)

rr_func(data=D_water, taxt=, day=2,
        sna=sprintf("%s/Rarecurve_water_ASV_day2.pdf", fd), sn=50)
rr_func(data=D_water, taxt=, day=4,
        sna=sprintf("%s/Rarecurve_water_ASV_day4.pdf", fd), sn=50)
rr_func(data=D_water, taxt=, day=6,
        sna=sprintf("%s/Rarecurve_water_ASV_day6.pdf", fd), sn=50)
rr_func(data=D_water, taxt=, day=8,
        sna=sprintf("%s/Rarecurve_water_ASV_day8.pdf", fd), sn=50)
